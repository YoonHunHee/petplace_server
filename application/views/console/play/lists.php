<div class="row">
  <div class="col-md-12 col-sm-6 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
            <form name="wform" method="post" action="/console/play/del">
            <input type="hidden" name="id"/>
                ...
                <table class="table table-striped responsive-utilities jambo_table bulk_action">
                    ...
                    <?php foreach ($list as $key=>$row) {?>
                        <tr class="<?=($key%2==0) ? 'even' : 'odd';?> pointer">
                            ...
                            <td class=" last">
                                <a href="/console/play/form/<?=$row['id']?>"><i class="fa fa-pencil-square-o"></i></a>
                ...
                <a href="/console/play/form" class="btn btn-success btn-sm">Add</a>
                <a href="/console/play/get_json" class="btn btn-success btn-sm">Json</a>
            </form>
            </div>
        </div>
    </div>
